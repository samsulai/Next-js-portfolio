...
const Contacts = () => {
	return (
		<section className="max-w-contentContainer mx-auto py-10 xl:py-32 flex flex-col gap-4 items-center justify-center">
...
Whether you have a question or just want to say hi, i'll try my best to get back to you.
			...
			<a href="mailto:samuelsulai2015@gmail.com">
			{" "}
